function params = slowvision_getParams(params)
% function params = slowvision_getParams(params)
    
    params.taskSet.numBlocks = 2;
    params.taskSet.numBlockSections = 2;
    params.taskSet.numTrialsPerSection = 60;
    ...
    params.timing.intertrialSet = [1.5 2.0 2.5 3.0 3.5 4.0 4.5]; % range in seconds
    params.timing.stimulusDuration = 0.007;  % seconds
    params.timing.responseStartSet = [0.45 0.5 0.55]; % range in seconds
    params.timing.responseTime = 3;  % seconds given to respond
    
    params.timing.sectionBreak = 40;
    params.timing.blockBreak = 80; % minimum number of seconds between blocks as break
